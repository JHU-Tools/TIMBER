...
def AutoJME(a, jetCollection, year, dataEra='', calibrate=True):
    ...
    # h3 = a.DataFrame.Histo1D(('test3','test3',100,0,300),'FatJet_msoftdrop_JES__down')
    # h4 = a.DataFrame.Histo1D(('test4','test4',100,0,300),'FatJet_msoftdrop')
    # h1.SetLineColor(ROOT.kBlack)
    # h2.SetLineColor(ROOT.kRed)
    ...
    # leg.SetTextFont(42)
    # leg.SetTextSize(0.035)
    # leg.AddEntry(h1.GetPtr(),"Nom","L")
    # leg.AddEntry(h2.GetPtr(),"Up","L")
    # leg.AddEntry(h3.GetPtr(),"Down","L")
    # leg.AddEntry(h4.GetPtr(),"no corr","L")
    # leg.Draw()
    ...
    # h3 = a.DataFrame.Histo1D(('test3','test3',100,0,300),'FatJet_msoftdrop_JER__down')
    # h4 = a.DataFrame.Histo1D(('test4','test4',100,0,300),'FatJet_msoftdrop')
    # h1.SetLineColor(ROOT.kBlack)
    # h2.SetLineColor(ROOT.kRed)
    # h3.SetLineColor(ROOT.kBlue)
