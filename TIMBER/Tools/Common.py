...
def rebin_TH1(h, bins, name = "default"):
    '''Rebin TH1.
    @param h: ROOT:TH1, input TH1.
    @param bins: array.array("d", [] ),   new bins. The edges of the new bins should be included in the input TH1.
    @param name: name of the new TH1. Also give a unique one to avoid double defination in the ROOT workspace.
    '''
...
def rebin_TH2(h, xbins, ybins, name = "default"):
    '''Rebin TH2.
    @param h: ROOT:TH2, input TH2.
    @param xbins, ybins: array.array("d", [] ),   new bins. The edges of the new bins should be included in the input TH2.
    @param name: name of the new TH2. Also give a unique one to avoid double defination in the ROOT workspace.
    '''
